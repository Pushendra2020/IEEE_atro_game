...
if (sessionStorage.getItem("hasReloaded")) {
    ...
    window.location.href = `http://${ip}:5000/pat.html`;
} else {
...
const pay_more = document.getElementById("pay_more");
pay_more.style.display = "none";
socket.on("waiting", () => {
...
socket.on("approved", () => {
    ...
    if (ooop === "none") {
        ...
        asteroidImage.src = 'Photos/astro_pho2-min.png'; // Path to the asteroid image
